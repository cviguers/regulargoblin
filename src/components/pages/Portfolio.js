...
const Portfolio = () => {
  const projects = [
    ...
    },
    {
      title: "Tech Blog",
      description:
        "This is a space where developers can publish their blog posts and comment on other developers posts as well. This application follows the MVC paradigm in its architectural structure, using Handlebars.js as the templating language, Sequelize as the ORM, and the express-session npm package for authentication.",
      image: techblogImg,
    ...
    },
    {
      title: "Pokedex",
      description:
        "This filing system acts as a Pokedex and pulls information from the PokeApi and the images from the GiphyApi to render cards on the screen displaying information about the user-searched Pokemon.",
      image: pokedexImg,
    ...
    },
    {
      ...
      description:
        "The command line application prompts the user to select a color and shape, provide text for the logo, and save the generated SVG to a .svg file. Each aspect of the logo, including the color, shape, and text, has been tested using Jest.",
      image: logoImg,
